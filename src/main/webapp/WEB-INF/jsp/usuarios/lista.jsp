                                    ...
                                    <div class="links" style="justify-content: flex-end;">
                                        ...
                                        <c:choose>
                                            <c:when test="${sessionScope.usuarioLogado.id != usuario.id}">
                                                <a class="btn-icon btn-icon-danger" href="${pageContext.request.contextPath}/usuarios?acao=excluir&id=${usuario.id}" onclick="return confirm('Deseja realmente excluir este usuário?');" title="Excluir usuário">
                                                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                        <path d="M3 6h18"/>
