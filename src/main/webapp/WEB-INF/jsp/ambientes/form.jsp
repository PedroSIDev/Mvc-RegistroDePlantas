    ...
    <form action="${pageContext.request.contextPath}/ambientes" method="post" class="card">
        ...
        <div class="form-grid">
            <div class="form-group full-width">
                ...
                <input id="nome" name="nome" maxlength="100" type="text" value="<c:out value='${ambiente.nome}'/>" placeholder="Ex: Sala de Estar, Varanda Gourmet, Escritório" required>
            </div>

            <div class="form-group full-width">
                <label for="descricao">Descrição / Luminosidade</label>
                <textarea id="descricao" name="descricao" maxlength="255" placeholder="Ex: Sol direto pela manhã, ventilação constante, espaço ideal para folhagens tropicais..."><c:out value="${ambiente.descricao}"/></textarea>
