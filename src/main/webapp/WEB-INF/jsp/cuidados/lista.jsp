                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <div class="links" style="justify-content: flex-end;">
                                        ...
                                        <a class="btn-icon btn-icon-danger" href="${pageContext.request.contextPath}/cuidados?acao=excluir&id=${cuidado.id}" onclick="return confirm('Deseja realmente excluir este cuidado?');" title="Excluir cuidado">
                                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M3 6h18"/>
